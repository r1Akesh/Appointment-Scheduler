...
if(!isset($_SESSION['username']))
{
    ...
    if(isset($_POST['select_time'])){
         ...
         $_SESSION['time']= $_POST['date_selected'];
         header('location:Free_Time.php');
...
<body>
<div style="margin-left: 70px;margin-right: 70px;height: 696px;border: 2px solid #000000">
    ...
    <div style="width: 100%;height: 40px;background-color: #ffffff;border: 3px solid #dcdcdc;border-left: hidden;border-right: hidden">
        ...
        <div class="container-fluid" style="color: #ffffff;background-color: #ffffff">
            <div >
                <ul class="nav navbar-nav pull-right " id="nav" style="margin-right: 40px">
                    ...
                    <li class="active"><a  href="Free_slots.php" style="color: #563d7c" >Free Slots</a></li>
