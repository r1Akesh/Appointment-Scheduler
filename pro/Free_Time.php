...
while($var_2=mysql_fetch_array($var_1))
{
   ...
   if($_POST){
       ...
       $quer = "DELETE FROM booking WHERE id='$bname' AND date='$date_selected'";
        if(mysql_query($quer)){
            //echo "executed";
        }
        unset($_POST);
     ...
     <div class="modal-dialog" style="height: 600px;margin-top: 0px">
         <div class="modal-content">
             ...
             <div class="modal-body" style="height: 100%">
                ...
                <button value="Back" style="float: right"><a href="Free_slots.php">Back</a></button>
         </div>
         </div>
     </div>
 </div>
